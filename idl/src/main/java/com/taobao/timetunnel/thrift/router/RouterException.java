...
public class RouterException extends Exception implements TBase<RouterException, RouterException._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("RouterException");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(RouterException.class, metaDataMap);
  }
   ...
   */
  public RouterException(RouterException other) {
  ...
  public RouterException deepCopy() {
    return new RouterException(this);
  }
  ...
  public RouterException setCode(short code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public RouterException setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public RouterException setDetail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RouterException)
      return this.equals((RouterException)that);
    return false;
  }

  public boolean equals(RouterException that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RouterException other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RouterException typedOther = (RouterException)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RouterException(");
    boolean first = true;
