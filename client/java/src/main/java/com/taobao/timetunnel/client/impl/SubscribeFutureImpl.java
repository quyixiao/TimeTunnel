...
import com.taobao.timetunnel.client.sub.VirtualSubConnection;
import com.taobao.timetunnel.client.sub.VirtualSubConnectionFactory;
...
public class SubscribeFutureImpl implements SubscribeFuture {
	...
	public SubscribeFutureImpl(Tunnel t) throws ClosedException {
		this.t = t;
